...
- ASSERTION-TITEL, KEINE THEMENSCHILDER: Jede Folienüberschrift (ausser Titel- und ASK-Folie) muss die Kernaussage der Folie als vollständige, konkrete Behauptung transportieren — nicht nur das Thema benennen. Schwach: "Marktentwicklung". Stark: "Der Markt wächst dreimal schneller als unsere Kapazität mithält". Wenn ein Publikum nur die Überschriften läse, müsste es der Argumentation trotzdem folgen können.
- SO-WHAT-TEST: Bevor du eine Folie abschliesst, prüfe: Wenn das Publikum nur diese eine Folie sehen würde — wäre sofort klar, warum sie für die Entscheidung relevant ist? Wenn nicht, schärfe die Kernaussage nach.
